...
class BillerCode803 implements BillerCdvInterface
{
    public function validate($mainField, $amount): bool
    {
        try {
            ...
            return $this->validateLength($mainField, 8) && $this->validateRange($mainField, 1, 49999999) && $this->validateCheckDigit($mainField);
        } catch (Throwable $th) {
